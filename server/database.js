...
async function initDatabase() {
  try {
    ...
    // Migrar qualquer valor antigo gemini-1.5-flash para gemini-2.0-flash para evitar erros de 404
    await pool.query("UPDATE Configuracoes SET valor = 'gemini-2.0-flash' WHERE chave = 'gemini_model' AND valor = 'gemini-1.5-flash'");
